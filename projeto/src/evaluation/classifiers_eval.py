...
class ModelEvaluation():
    ...
    def cross_val_evaluate(self):
        ...
        skf = StratifiedKFold(self.n_splits, shuffle=True, random_state=load_config_file().get('random_state'))

        scores = cross_val_score(self.model, self.dados_x, self.dados_y, cv=skf, scoring='roc_auc')
